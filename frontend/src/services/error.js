...
const translations = {
  ru: {
    ...
    managerJoinUnavailable: 'Вступление менеджера по инвайт-коду пока недоступно на бэкенде.',
  ...
  en: {
    ...
    managerJoinUnavailable: 'Manager join by invite code is not available on the backend yet.',
